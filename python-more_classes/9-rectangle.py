...
active instances. Additionally, it includes a static method to compare
two rectangles by area and a class method to create a square.
"""
...
class Rectangle:
    ...
    Methods:
        ...
        square(cls, size=0):
            ...
            Returns:
                Rectangle: A new Rectangle instance where width and height are
                equal to size.
    """

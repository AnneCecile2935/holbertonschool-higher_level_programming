...
class Student:
    ...
    Méthodes:
        ...
        reload_from_json(json): remplace les attributs de l'instance par ceux
        contenus dans un dictionnaire json.
    """
    ...
    def reload_from_json(self, json):
        """
        Remplace les attributs de l'instance avec ceux fournis dans

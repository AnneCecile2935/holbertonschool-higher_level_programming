...
SELECT
  ...
  COUNT(tv_show_genres.show_id) AS count -- Le nombre de shows liés à ce genre
FROM
...
GROUP BY
  tv_genres.id                          -- Regroupe les résultats par genre
ORDER BY
  count DESC;                          -- Trie les résultats par nombre de shows décroissant
